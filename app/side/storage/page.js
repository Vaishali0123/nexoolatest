...
function page() {
  ...
  //   setFilestorage(`${(file.size / 1024).toFixed(2)} KB`);
  //   setUploadpop(false);
  //   setData([
  //     ...data,
              ...
              <div className="px-2 w-full flex flex-col gap-1">
                <div className="text-sm text-[#615E83]">
                  <div className="flex flex-row items-center justify-between w-[100%]">
                    ...
                    <div className="text-[#121212] text-[12px] ">4.5 GB</div>
                ...
                >
                  <div className="flex items-center sm:w-[30%] w-[70%] px-1 space-x-2">
                    ...
                    <div>
                      ...
                      <div className=" sm:hidden px-1">{d.size}</div>
                    </div>
                  </div>
                  <div className="w-[15%] pn:max-sm:hidden px-1">{d.size}</div>
                  ...
                  <div className=" sm:w-[5%] w-[20px] flex justify-start items-center">
